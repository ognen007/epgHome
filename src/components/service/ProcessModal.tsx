...
import statisticsTablet from '../../assets/tablet.png'; // Adjust the image path accordingly
...
export const ProcessModal = () => {
  const { ref, inView } = useInView({
    ...
    return (
        <Box w="100%" p={1} mt={"-100px"} mx="auto" maxW="1200px" ref={ref}>
      <Flex
      mt={"120px"}
      ...
      >
        ...
        style={{
          ...
          transition: "all 1s ease-out",
              ...
              <Image
                src={statisticsTablet} // The image for the appointments
